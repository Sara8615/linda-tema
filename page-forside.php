...
<main class="splash">
  <div class="iframecon">
  <iframe width="1200" height="600" src="https://www.youtube.com/embed/WPIq1my_J8o?loop=1&autoplay=1&controls=0&mute=1&playlist=WPIq1my_J8o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	</div>
   <!-- <img class="forsidebillede" src="<?php echo get_stylesheet_directory_uri() ?>/linda-2.jpg" alt="forsidebillede"> -->
<div class="forside-socials">
