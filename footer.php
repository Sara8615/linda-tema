...
<div class="footerlogocon">
   <a href=https://sarahduarte.dk/kea/10_eksamen/forside><img class="linda-logo-footer" src="<?php echo get_stylesheet_directory_uri() ?>/signatur-linda-brun.webp" alt="linda-logo"></a>
</div>
   ...
   <!--titler-->
   <div class="f-titler">
    <p class="f-p-1"> LINDA ANDREWS </p>
    <p class="f-p-2"> SANGERINDE </p>
    <p class="f-p-3"> PERFORMER </p>
 <p class="f-p-4"> SANG COACH </p>
    <p class="f-p-5"> KORDIRIGENT</p>
    </div>
</div>
