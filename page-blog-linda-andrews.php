...
<article class="blog_grid_1">
    <h2 class="element_1"> AGE*ISM</h2> 
...
<div class="element_3_img">
<img class="element_3" src="<?php echo get_stylesheet_directory_uri() ?>/top-banner-blog.webp" alt="billede">
</div>
