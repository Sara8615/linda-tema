...
<p class="bio_text">The standard Lorem Ipsum passage, used since the 1500s
...
<p class="bio_overskrift"> Section 1.10.32 of "de Finibus Bonorum et Malorum".
</p>
<p class="bio_text"> "Sed ut perspiciatis unde omnis iste natus error sit voluptatem 
...
<div class="bio-grid"> 
<img class="bio_billede_2"src="<?php echo get_stylesheet_directory_uri() ?>/citat-bio.webp" alt="lille bio billede">
...
<p class="bio_overskrift"> Section 1.10.32 of "de Finibus Bonorum et Malorum", written by Cicero in 45 BC
</p>
<p class="bio_text"> 
...
<p class="bio_overskrift"> Section 1.10.32 of "de Finibus Bonorum et Malorum", written by Cicero in 45 BC
 ...
 <img class="bio_billede_3"src="<?php echo get_stylesheet_directory_uri() ?>/banner-bio.webp" alt="fullwidth-img-2">
</div>
</main>
